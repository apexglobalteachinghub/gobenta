...
export default async function ProfilePage() {
  ...
  const myRatings = await getUserRatingStats(user.id);
  const received = await getReceivedReviews(user.id);
  const activeListings = await getActiveListingsForUser(user.id);
